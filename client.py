...
st.write('<h1 style="text-align:center">Covid-19 Analysis</h1>', unsafe_allow_html=True)
st.write('<h2 style="text-align:center">using MongoDB</h2>', unsafe_allow_html=True)
...
add_bg_from_local('C:\\Users\\rchar\\OneDrive\\Pictures\\Saved Pictures\\corona.jpg') 
